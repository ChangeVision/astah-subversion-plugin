...
//            }
            ...
            SVNWCClient client = getSVNWCClient(utils, fileName);
...
//        }
    ...
    public SVNWCClient getSVNWCClient(SVNUtils utils, String fileName) {
        SVNWCClient client = null;

        // 引数チェック
        if (utils == null || fileName == null || fileName.length() == 0) {
            return null;
        }
    ...
    public String getBaseFile(String filePath, String fileName, SVNWCClient client) {
        // 引数チェック
        if (client == null
        ...
        try {
            ...
            client.doGetFileContents(new File(filePath + fileName), SVNRevision.UNDEFINED, null, false, baseFile);
            baseFile.close();
